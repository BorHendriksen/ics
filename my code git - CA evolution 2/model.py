...
class SIRModel(Model):
    ...
    def __init__(self, width, height):
        ...
        self.infectivity        = 5.0               # Infection strength per infected individual
        self.infection_duration = 8                # Duration of infection
        self.immunity_duration  = 15                # Duration of immunity
