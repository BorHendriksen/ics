    ...
    def step(self):
        ...
        # Infected - recover after disease_duration
            ...
            # Else count how long it has been ill and apply potential mutations     #Mutation should be add here
                ...
                self.timecounter += 1   
                rand=random.random()
                mu_2=0.1                                  #Mutation probability
                if rand < mu_2:
                    step_2 = random.uniform(-1, 1)
                    self._nextinfduration = self._nextinfduration + step_2
                
                #if rand<mu*0.5:                              
                #    self._nextinfduration += 1          #Mutation to more duration
                #elif rand<mu:
                #    self._nextinfduration = self._nextinfduration-1      #Mutation to less duration
